        ...
        <div class="w-full text-gray-700 bg-gray-200 shadow-lg fixed inset-x-0 top-0 z-20">
          <div x-data="{ open: false }" class="flex flex-col max-w-screen-xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
            ...
            <nav :class="{'flex': open, 'hidden': !open}" class="flex-col flex-grow pb-4 md:pb-0 hidden md:flex md:justify-end md:flex-row">
              ...
              <a class="px-4 py-2 mt-2 text-sm font-semibold bg-transparent md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-green-500 focus:bg-gray-200 focus:outline-none focus:shadow-outline {{ \Route::currentRouteName() === 'about' ? 'text-gray-900 bg-green-500' : '' }}" href="{{ route('about') }}">{{ __('posts.about') }}</a>
              <a class="px-4 py-2 mt-2 text-sm font-semibold bg-transparent md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-green-500 focus:bg-gray-200 focus:outline-none focus:shadow-outline {{ \Route::currentRouteName() === 'contact' ? 'text-gray-900 bg-green-500' : '' }}" href="{{ route('contact') }}">{{ __('posts.contact') }}</a>
