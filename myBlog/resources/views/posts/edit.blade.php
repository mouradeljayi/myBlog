  ...
  <div class="bg-gray-200 rounded p-6">
    <form action="{{ route('posts.update', $post) }}" method="post" enctype="multipart/form-data">
      ...
      <div class="mb-4">
        ...
        <textarea name="body[{{ $key }}]" rows="40" cols="80" class="text-lg shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ old('body.' . $key, $post->getTranslation('body', $key)) }}</textarea>
      </div>
      @endforeach
